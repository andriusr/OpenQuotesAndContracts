...
<tr height='20'>
	...
	{foreach name=rowIteration from=$data key=id item=rowData}
		...
		{assign var='_bgColor' value=$rowData.customRowColor} 
		 ...
		 {* <tr height='20' class='{$_rowColor}S1' bgcolor='{$_bgColor}'> *}
		 <tr height='20' class='{$_rowColor}S1' style='background-color:{$_bgColor}'>
			{if $prerow}
		{*	<td width='1%' class='nowrap' bgcolor='{$_bgColor}'> *}
			<td width='1%' class='nowrap' style='background-color:{$_bgColor}'>
