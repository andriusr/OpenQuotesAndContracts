     ...
     //   array('file' => 'include/oqc/Services/NegotiatedPrice.js'),
      ...
      array (
        ...
        array (
          ...
          1 => 'DUPLICATE',
          2 => 'DELETE',
          3 => array('customCode' => '<input title="{$MOD.LBL_CREATE_PDF}" accessKey="{$MOD.LBL_CREATE_PDF_BUTTON_KEY}" type="button" class="button" onClick="document.location=\'index.php?module=oqc_Offering&action=CreatePdf&record={$fields.id.value}\'" name="createPdf" value="{$MOD.LBL_CREATE_PDF}">'
          ),
          4 => 
          array (
            'customCode' => '<input title="{$MOD.LBL_CREATE_CONTRACT}" type="button" class="button" onClick="document.location=\'index.php?module=oqc_Offering&action=CreateContract&record={$fields.id.value}\'" name="createContract" value="{$MOD.LBL_CREATE_CONTRACT}">',
          ),
          5 => array('customCode' => '<input title="{$MOD.LBL_CREATE_TASK}" accessKey="{$MOD.LBL_TASK_BUTTON_KEY}" type="button" class="button" onClick="document.location=\'index.php?module=oqc_Task&action=EditView&relate_id={$fields.id.value}&relate_to=oqc_Offering&parent_id={$fields.id.value}&parent_name={$fields.name.value}&parent_type=oqc_Offering\'" name="createTask" value="{$MOD.LBL_CREATE_TASK}">'
          ),
          6 => array('customCode' => '<input title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick="open_popup(\'oqc_Audit\', \'600\', \'400\', \'&record={$fields.id.value}&module_name=oqc_Offering\', true, false,  {ldelim} \'call_back_function\':\'set_return\',\'form_name\':\'EditView\',\'field_to_name_array\':[] {rdelim} ); return false;" value="{$APP.LNK_VIEW_CHANGE_LOG}" type="submit">'),
        ),
        'hideAudit' => 'true',
      ),
      'maxColumns' => '2',
