...
<foreach from=$rootCategories item=category>
		...
		\titleformat{\sub<$section>}{\itshape\bfseries\titlerule\vspace{0.7ex}}{\makebox[5em][l]{\thesub<$section>}}{0em}{}[\vspace{0.7ex}\titlerule]
			<foreach from=$category.products item=product name=products>
				...
				<if !empty($product.options)>
					<include file="include/oqc/Pdf/ProductCatalog2/CategoryOptions.tpl" product=$product section="sub"|cat:$section>
				</if>		
				<else>
	...
	<include file="include/oqc/Pdf/ProductCatalog2/Categories.tpl" rootCategories=$category.subCategories section="sub"|cat:$section counter=$counter|cat:$current_counter>
</foreach>
</if>
