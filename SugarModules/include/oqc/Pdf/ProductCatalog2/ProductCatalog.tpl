...
<include file="include/oqc/Pdf/ProductCatalog2/Intro.tpl">
<include file="include/oqc/Pdf/ProductCatalog2/Contact.tpl">
<include file="include/oqc/Pdf/ProductCatalog2/Validity.tpl">

\section*{\textbf{<$language.pdf.catalog.services>}}
<include file="include/oqc/Pdf/ProductCatalog2/Categories.tpl" rootCategories=$categoriesAndProducts section="section">
