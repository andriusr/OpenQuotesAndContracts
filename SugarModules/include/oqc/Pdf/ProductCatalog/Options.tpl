...
<if $i != 0>~</if>~\addtocounter{oqc_opt}{1}\ref{categoryId<$category.id|replace:"-":"">}.\alph{oqc_pn}.\arabic{oqc_opt}&
\textit{<$option.name>}&
<$option.unit>& 
...
<include file="include/oqc/Pdf/ProductCatalog/Options.tpl" product=$option>
</if>	
</foreach>
</if>
