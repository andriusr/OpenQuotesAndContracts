...
<include file="include/oqc/Pdf/ProductCatalog3/Intro.tpl">
<include file="include/oqc/Pdf/ProductCatalog3/Contact.tpl">
<include file="include/oqc/Pdf/ProductCatalog3/Validity.tpl">

\newcounter{oqc_opt}
\newcounter{oqc_pn}
<include file="include/oqc/Pdf/ProductCatalog3/ProductTables.tpl" rootCategories=$categoriesAndProducts section="section">
