...
{* this file is based on include/EditView/footer.tpl *}
...
<input class="button" type="button" value="Save" name="button" onclick="if (check_form('EditView')) return save_popup_and_close(''); return false;" />

<input class="button" style="margin-left:0.5em" type="button" value="Cancel" name="button" onclick="window.close();" />
